...
[YH, Cb_of_YH_original, Cr_of_YH_original] = GetDataMatrix([imgPath 'hres/'],...
...
imshow(ycbcr2rgb(uint8(recon*255)));
title('Actual_HRes')
...
for gr = 1:2000
    ...
    recon_model = patch2im(...
        ...
        r, reduceTo_hres, reduceTo_hres,...
        patchsize_hres, Cb_of_YH_original, Cr_of_YH_original, overlap_high);
    imshow(ycbcr2rgb(recon_model))
    title('Recon_HRes')
    fprintf('PSNR[ModelH]: %10.8f\n', psnr(recon_model(:,:,1), recon(:,:,1)));
